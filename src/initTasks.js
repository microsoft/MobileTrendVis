...
function initTasks() {
  ...
  if (window.location.href.indexOf('mobubble') == -1) {
    ...
    //determine condition
    switch (globals.visitor_number % 3) {
      
      case 0:    
        globals.condition = 'multiples'; 
        break;

      case 1:    
        globals.condition = 'animation'; 
        break;
    ...
    //determine ordering
    globals.ordering = globals.visitor_number % 2;
    globals.trials = taskList[(globals.visitor_number % 2)];     
    ...
    console.log({ 
      ...
      "visitor_number": globals.visitor_number,
